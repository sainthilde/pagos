...
public interface FichaTecnicaDetMapper {
    FichaTecnicaDetModel entityToModel(FichaTecnicaDet fichaTecnicaDet);


    @Named("toFichaTecnicaDetDto")
    FichaTecnicaDetModel toFichaTecnicaDetDto(FichaTecnicaDet fichaTecnicaDet);
}
